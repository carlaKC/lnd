...
var (
	...
	// ErrNoUpdateAddOnChain is returns when an on chain HTLC is resumed
	// with custom tlv records for UpdateAddHLTC, since it's impossible to
	// send this message once the HTLC is on chain.
	ErrNoUpdateAddOnChain = errors.New("cannot provide custom records " +
		"on-chain")
