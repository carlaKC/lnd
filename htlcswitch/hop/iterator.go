...
var (
	...
	// ErrNoNextChanID is returned when a blinded payment does not specify
	// the next short channel ID.
	ErrNoNextChanID = errors.New("next channel id required for blinded " +
		"payments")
