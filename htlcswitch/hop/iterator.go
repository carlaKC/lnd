...
var (
	...
	// for a validated payload with encrypted data set.
...
// blinding points set (or not). Note that if both blinding points are set
// we return the role of an introduction node (order matters) so that we'll
// conservatively handle errors.
