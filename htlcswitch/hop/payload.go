...
// requirements for this method are described in BOLT 04. If the paylaod is for
...
func validateBlindedRouteTypes(parsedTypes tlv.TypeMap,
	...
	allowedTLVs := map[tlv.Type]struct{}{
		record.EncryptedDataOnionType: struct{}{},
		record.BlindingPointOnionType: struct{}{},
	}
	...
	for tlvType, tlvValue := range parsedTypes {
