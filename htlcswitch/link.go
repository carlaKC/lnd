...
type ChannelLinkConfig struct {
	...
	// ShouldFwdExperimentalEndorsement is a closure that indicates whether
	// the link should forward experimental endorsement signals.
	ShouldFwdExperimentalEndorsement func() bool
}
...
func (l *channelLink) experimentalEndorsement(
	...
	// period.
	if !l.cfg.ShouldFwdExperimentalEndorsement() {
		return fn.None[byte]()
	}
