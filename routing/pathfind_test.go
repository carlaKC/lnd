...
func parseTestGraph(path string) (*testGraphInstance, error) {
	...
	links := make(map[lnwire.ChannelID]htlcswitch.ChannelUpdateHandler)
...
type testGraphInstance struct {
	...
	links map[lnwire.ChannelID]htlcswitch.ChannelUpdateHandler
}

// getLink is a mocked link lookup function which looks up links in our test
// graph.
func (g *testGraphInstance) getLink(chanID lnwire.ChannelID) (
