...
type QueryRoutesRequest struct {
	...
	BlindedPath []*BlindedPayment `protobuf:"bytes,19,rep,name=blinded_path,json=blindedPath,proto3" json:"blinded_path,omitempty"`
	// Features assumed to be supported by the final node. All transitive feature
	// dependencies must also be set properly. For a given feature bit pair, either
	// optional or remote may be set, but not both. If this field is nil or empty,
	// the router will try to load destination features from the graph as a
...
type Hop struct {
	...
	// nodes in blinded paths. This field is mandatory for hops that represent
	// the introduction point in a blineded path.
...
type BlindedPayment struct {
	...
	// The total CLTV delta for the blinded path provided, *not* including the
...
func (x *BlindedPayment) GetBlindedPath() *BlindedPath {
	if x != nil {
		return x.BlindedPath
	}
	return nil
...
func (x *BlindedPayment) GetBaseFeeMsat() uint64 {
	if x != nil {
...
func (x *BlindedPayment) GetProportionalFeeMsat() uint64 {
	if x != nil {
...
func (x *BlindedPayment) GetHtlcMinMsat() uint64 {
	if x != nil {
...
func (x *BlindedPayment) GetHtlcMaxMsat() uint64 {
	if x != nil {
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x42, 0x6c, 0x69, 0x6e,
	...
	0x52, 0x08, 0x68, 0x6f, 0x70, 0x48, 0x69, 0x6e, 0x74, 0x73, 0x22, 0xc0, 0x02, 0x0a, 0x0e, 0x42,
	0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x35, 0x0a,
	...
	0x6f, 0x72, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x5f, 0x66, 0x65, 0x65, 0x5f, 0x6d, 0x73, 0x61,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x13, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x72, 0x74,
	0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x46, 0x65, 0x65, 0x4d, 0x73, 0x61, 0x74, 0x12, 0x28, 0x0a, 0x10,
...
var file_lightning_proto_depIdxs = []int32{
	...
	148, // 111: lnrpc.BlindedPayment.blinded_path:type_name -> lnrpc.BlindedPath
	9,   // 112: lnrpc.BlindedPayment.features:type_name -> lnrpc.FeatureBit
	149, // 113: lnrpc.BlindedPath.blinded_hops:type_name -> lnrpc.BlindedHop
