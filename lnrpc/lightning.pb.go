...
func (x *LookupHtlcRequest) Reset() {
	*x = LookupHtlcRequest{}
...
func (x *LookupHtlcRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LookupHtlcRequest) ProtoMessage() {}

func (x *LookupHtlcRequest) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[0]
...
// Deprecated: Use LookupHtlcRequest.ProtoReflect.Descriptor instead.
func (*LookupHtlcRequest) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{0}
}

func (x *LookupHtlcRequest) GetChanId() uint64 {
	if x != nil {
		return x.ChanId
	}
	return 0
...
func (x *LookupHtlcRequest) GetHtlcIndex() uint64 {
	if x != nil {
		return x.HtlcIndex
	}
	return 0
...
type LookupHtlcResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LookupHtlcResponse) Reset() {
	*x = LookupHtlcResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *LookupHtlcResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LookupHtlcResponse) ProtoMessage() {}

func (x *LookupHtlcResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LookupHtlcResponse.ProtoReflect.Descriptor instead.
func (*LookupHtlcResponse) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{1}
}

func (x *LookupHtlcResponse) GetSettled() bool {
	if x != nil {
		return x.Settled
	}
	return false
...
func (x *LookupHtlcResponse) GetOffchain() bool {
	if x != nil {
		return x.Offchain
	}
	return false
...
type QueryRoutesRequest struct {
	...
	// An optional blinded path to reach the destination via. Note that the
	// introduction node included in this path *must* be the same as the target
	// pubkey provided, and there must be at least two hops in the path.
	BlindedPath *BlindedPayment `protobuf:"bytes,19,opt,name=blinded_path,json=blindedPath,proto3" json:"blinded_path,omitempty"`
	// Features assumed to be supported by the final node. All transitive feature
	// dependencies must also be set properly. For a given feature bit pair, either
	// optional or remote may be set, but not both. If this field is nil or empty,
	// the router will try to load destination features from the graph as a
...
func (x *QueryRoutesRequest) GetBlindedPath() *BlindedPayment {
	if x != nil {
...
type Hop struct {
	...
	// arbitrary blob of data from our node's perspective.
...
type BlindedPayment struct {
	...
	// The blinded route to send the payment to.
	Route *BlindedRoute `protobuf:"bytes,1,opt,name=route,proto3" json:"route,omitempty"`
	// The aggregate base fee for hops in the blinded portion of the route,
	// expressed in millisatoshis.
	AggregateBaseFeeMsat uint64 `protobuf:"varint,2,opt,name=aggregate_base_fee_msat,json=aggregateBaseFeeMsat,proto3" json:"aggregate_base_fee_msat,omitempty"`
	// The aggregate proportional fee for hops in the blinded portion of the
	// route, expressed in micro-satoshis (parts per million).
	AggregateProportionalFeePpm uint64 `protobuf:"varint,3,opt,name=aggregate_proportional_fee_ppm,json=aggregateProportionalFeePpm,proto3" json:"aggregate_proportional_fee_ppm,omitempty"`
	// The total cltv expiry for the blinded portion of the route.
	...
	// The cltv limit for the route.
	CltvLimit uint32 `protobuf:"varint,5,opt,name=cltv_limit,json=cltvLimit,proto3" json:"cltv_limit,omitempty"`
	// The minimum hltc size for the route.
	MinHtlc uint64 `protobuf:"varint,6,opt,name=min_htlc,json=minHtlc,proto3" json:"min_htlc,omitempty"`
	// The maximum hltc size for the route.
	MaxHtlc uint64 `protobuf:"varint,7,opt,name=max_htlc,json=maxHtlc,proto3" json:"max_htlc,omitempty"`
	// The feature bits for the route.
	Features []FeatureBit `protobuf:"varint,8,rep,packed,name=features,proto3,enum=lnrpc.FeatureBit" json:"features,omitempty"`
}

func (x *BlindedPayment) Reset() {
	*x = BlindedPayment{}
	if protoimpl.UnsafeEnabled {
...
func (x *BlindedPayment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlindedPayment) ProtoMessage() {}

func (x *BlindedPayment) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[127]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlindedPayment.ProtoReflect.Descriptor instead.
func (*BlindedPayment) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{127}
}

func (x *BlindedPayment) GetRoute() *BlindedRoute {
	if x != nil {
		return x.Route
	}
	return nil
...
func (x *BlindedPayment) GetAggregateBaseFeeMsat() uint64 {
	if x != nil {
		return x.AggregateBaseFeeMsat
	}
	return 0
}

func (x *BlindedPayment) GetAggregateProportionalFeePpm() uint64 {
	if x != nil {
		return x.AggregateProportionalFeePpm
	}
	return 0
}

func (x *BlindedPayment) GetTotalCltvDelta() uint32 {
	if x != nil {
...
func (x *BlindedPayment) GetCltvLimit() uint32 {
	if x != nil {
		return x.CltvLimit
	}
	return 0
...
func (x *BlindedPayment) GetMinHtlc() uint64 {
	if x != nil {
		return x.MinHtlc
	}
	return 0
...
func (x *BlindedPayment) GetMaxHtlc() uint64 {
	if x != nil {
		return x.MaxHtlc
	}
	return 0
...
func (x *BlindedPayment) GetFeatures() []FeatureBit {
	if x != nil {
		return x.Features
	}
	return nil
...
func (x *BlindedRoute) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlindedRoute) ProtoMessage() {}

func (x *BlindedRoute) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[128]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlindedRoute.ProtoReflect.Descriptor instead.
func (*BlindedRoute) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{128}
}

func (x *BlindedRoute) GetIntroductionNode() []byte {
	if x != nil {
...
func (x *BlindedRoute) GetBlindingPoint() []byte {
	if x != nil {
		return x.BlindingPoint
	}
	return nil
...
func (x *BlindedRoute) GetBlindedHops() []*BlindedHop {
	if x != nil {
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x22, 0x4b, 0x0a, 0x11, 0x4c, 0x6f, 0x6f, 0x6b,
	0x75, 0x70, 0x48, 0x74, 0x6c, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a,
	...
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x4a, 0x0a, 0x12, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x48,
	0x74, 0x6c, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73,
	...
	0x6e, 0x22, 0x20, 0x0a, 0x1e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x4b, 0x0a, 0x0d, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x65, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	...
	0x22, 0x56, 0x0a, 0x18, 0x53, 0x65, 0x6e, 0x64, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04,
	0x70, 0x65, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x65, 0x65, 0x72,
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x1b, 0x0a, 0x19, 0x53, 0x65, 0x6e, 0x64,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xe6, 0x01, 0x0a, 0x04, 0x55, 0x74, 0x78, 0x6f, 0x12, 0x35,
	0x0a, 0x0c, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0
 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x54,
	...
	0x43, 0x45, 0x44, 0x5f, 0x4c, 0x45, 0x41, 0x53, 0x45, 0x10, 0x04, 0x2a, 0x61, 0x0a, 0x09, 0x49,
	...
	0x41, 0x4d, 0x45, 0x54, 0x45, 0x52, 0x10, 0x04, 0x32, 0xd2, 0x26, 0x0a, 0x09, 0x4c, 0x69, 0x67,
	...
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x4c, 0x6f,
	0x6f, 0x6b, 0x75, 0x70, 0x48, 0x74, 0x6c, 0x63, 0x12, 0x18, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63,
	0x2e, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x48, 0x74, 0x6c, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x19, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4c, 0x6f, 0x6f, 0x6b, 0x75,
	0x70, 0x48, 0x74, 0x6c, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x27, 0x5a,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*LookupHtlcRequest)(nil),                                   // 20: lnrpc.LookupHtlcRequest
	(*LookupHtlcResponse)(nil),                                  // 21: lnrpc.LookupHtlcResponse
	...
	(*BlindedPayment)(nil),                                      // 147: lnrpc.BlindedPayment
	(*BlindedRoute)(nil),                                        // 148: lnrpc.BlindedRoute
...
var file_lightning_proto_depIdxs = []int32{
	...
	215, // 7: lnrpc.SendRequest.dest_custom_records:type_name -> lnrpc.SendRequest.DestCustomRecordsEntry
	...
	216, // 12: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	217, // 13: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	218, // 32: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	...
	219, // 37: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	...
	221, // 59: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	224, // 60: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	225, // 61: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	222, // 62: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	226, // 70: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	227, // 80: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	146, // 81: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	147, // 82: lnrpc.QueryRoutesRequest.blinded_path:type_name -> lnrpc.BlindedPayment
	...
	228, // 87: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	...
	229, // 92: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	230, // 93: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	231, // 94: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	...
	232, // 97: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	...
	233, // 101: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	234, // 106: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	148, // 111: lnrpc.BlindedPayment.route:type_name -> lnrpc.BlindedRoute
	9,   // 112: lnrpc.BlindedPayment.features:type_name -> lnrpc.FeatureBit
	149, // 113: lnrpc.BlindedRoute.blinded_hops:type_name -> lnrpc.BlindedHop
	7,   // 114: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	146, // 115: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	16,  // 116: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	152, // 117: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	235, // 118: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	236, // 119: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 120: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	237, // 121: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	153, // 122: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	151, // 123: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	17,  // 124: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	160, // 125: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	122, // 128: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	203, // 129: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	159, // 130: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	37,  // 131: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	146, // 132: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	238, // 133: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	175, // 134: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	37,  // 135: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	38,  // 136: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	10,  // 137: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	178, // 138: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	181, // 139: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	37,  // 140: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	37,  // 141: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	37,  // 142: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	188, // 143: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	185, // 144: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	184, // 145: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	188, // 146: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	193, // 147: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	193, // 148: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	239, // 149: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	19,  // 150: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	204, // 151: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	206, // 152: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	193, // 153: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	210, // 154: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	211, // 155: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	211, // 156: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	213, // 157: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	214, // 158: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	173, // 159: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	173, // 160: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	220, // 163: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	220, // 164: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	223, // 165: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	220, // 166: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	220, // 167: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	104, // 168: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	109, // 170: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	173, // 171: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	133, // 172: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	173, // 173: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	173, // 174: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	150, // 175: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	173, // 176: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	200, // 177: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	110, // 178: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	113, // 179: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	29,  // 180: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	41,  // 181: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	45,  // 182: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	47,  // 183: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	29,  // 184: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	43,  // 185: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	49,  // 186: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	51,  // 187: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	53,  // 188: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	55,  // 189: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	57,  // 190: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	73,  // 191: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	75,  // 192: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	77,  // 193: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	79,  // 194: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	105, // 195: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	62,  // 196: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	107, // 197: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	69,  // 198: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	92,  // 199: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	92,  // 200: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	89,  // 201: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	102, // 202: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	36,  // 203: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	85,  // 204: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	167, // 205: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	32,  // 206: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	32,  // 207: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	34,  // 208: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	34,  // 209: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	151, // 210: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	156, // 211: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	155, // 212: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	158, // 213: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	171, // 214: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	161, // 215: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	163, // 216: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	164, // 217: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	129, // 218: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	131, // 219: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	134, // 220: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	123, // 221: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	115, // 222: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	135, // 223: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	137, // 224: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	139, // 225: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	169, // 226: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	174, // 227: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	177, // 228: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	180, // 229: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	183, // 230: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	186, // 231: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	187, // 232: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	189, // 233: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	191, // 234: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	194, // 235: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	196, // 236: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	198, // 237: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	201, // 238: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	207, // 239: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	212, // 240: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	65,  // 243: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	20,  // 244: lnrpc.Lightning.LookupHtlc:input_type -> lnrpc.LookupHtlcRequest
	111, // 245: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	114, // 246: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	30,  // 247: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	42,  // 248: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	46,  // 249: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	48,  // 250: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	28,  // 251: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	44,  // 252: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	50,  // 253: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	52,  // 254: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	54,  // 255: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	56,  // 256: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	58,  // 257: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	74,  // 258: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	76,  // 259: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	78,  // 260: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	80,  // 261: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	106, // 262: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	63,  // 263: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	108, // 264: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	70,  // 265: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	37,  // 266: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	93,  // 267: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	91,  // 268: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	103, // 269: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	35,  // 270: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	86,  // 271: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	168, // 272: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	33,  // 273: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	33,  // 274: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	33,  // 275: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	33,  // 276: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	154, // 277: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	157, // 278: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	151, // 279: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	151, // 280: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	172, // 281: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	162, // 282: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	165, // 283: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	166, // 284: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	130, // 285: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	132, // 286: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	128, // 287: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	124, // 288: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	118, // 289: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	136, // 290: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	138, // 291: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	140, // 292: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	170, // 293: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	176, // 294: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	179, // 295: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	182, // 296: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	184, // 297: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	187, // 298: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	192, // 299: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	190, // 300: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	187, // 301: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	195, // 302: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	197, // 303: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	199, // 304: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	202, // 305: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	208, // 306: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	209, // 307: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	66,  // 310: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	21,  // 311: lnrpc.Lightning.LookupHtlc:output_type -> lnrpc.LookupHtlcResponse
...
func file_lightning_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_lightning_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LookupHtlcRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_lightning_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LookupHtlcResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
