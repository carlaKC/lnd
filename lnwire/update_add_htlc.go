...
// nil.
func (u *UpdateAddHTLC) BlingingPointOrNil() *btcec.PublicKey {
	var blindingPoint *btcec.PublicKey
	u.BlindingPoint.WhenSome(func(b tlv.RecordT[BlindingPointTlvType,
		*btcec.PublicKey]) {
...
func (c *UpdateAddHTLC) Encode(w *bytes.Buffer, pver uint32) error {
	...
	//nolint:lll
	c.BlindingPoint.WhenSome(func(b tlv.RecordT[tlv.TlvType0, *btcec.PublicKey]) {
