...
const (
	...
	// ErrErroneousField indicates that a specific field is problematic.
	ErrErroneousField ErrorCode = 25
)
...
var knownErrorCodeContext = map[ErrorCode]ErrContext{
	...
	ErrErroneousField:   &ErroneousFieldErr{},
}
